...
import MainIcon from "../assets/LogeinLogo.svg"
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-">
      ...
      <div className="relative bg-gray-900/80 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-lg p-10 border border-gray-700/50">
        {/* Header */}
        <div className="text-center">
          <div className="flex items-center justify-center mb-[20px]">
            <Link to={"/"} > <img src={MainIcon} alt={MainIcon} /> </Link>
          </div>
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 bg-gray-800/50 border border-gray-600/50 rounded-xl hover:bg-gray-700/50 hover:border-gray-500/50 transition-all duration-300 group backdrop-blur-sm"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 bg-blue-600/90 text-white rounded-xl hover:bg-blue-600 transition-all duration-300 backdrop-blur-sm shadow-lg hover:shadow-blue-600/25"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 bg-gray-800/90 text-white rounded-xl hover:bg-gray-700 transition-all duration-300 backdrop-blur-sm border border-gray-600/30 hover:border-gray-500/50"
          >
            <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
