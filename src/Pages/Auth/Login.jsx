...
export default function Login() {
  ...
  const { login, gmailLogin, facebookLogin , twitterLogin , currentUser } = useAuth();
      ...
      <div className=" login_main relative bg-gray-900/80 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-lg p-10 border border-gray-700/50">
        ...
        <div className="space-y-3 mb-6">
          ...
          onClick={twitterLogin}
            className="w-full flex items-center justify-center px-4 py-3 bg-gray-800/90 text-white rounded-xl hover:bg-gray-700 transition-all duration-300 backdrop-blur-sm border border-gray-600/30 hover:border-gray-500/50 cursor-pointer "
          >
            <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
