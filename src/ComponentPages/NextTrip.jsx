        ...
        <div className="container">
            <div className="booking_container grid grid-cols-2 gap-2 justify-between items-center">
                <div className="booking_text">
                    <h3 className="text-[18px] font-poppins font-semibold mb-[15px] text-text-crl">Easy and Fast
                    </h3>
                    <h1 className="text-[50px] font-bold font-Volkhob text-[#14183E]  mb-[31px] max-w-[511px] ">Book Your Next Trip in 3 Easy Steps</h1>
                ...
                <div className="booking_image">
                    <img src={Nexttrip} alt="booking image" />
                </div>
